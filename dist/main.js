...
const createWindow = () => {
  ...
  const mainWindow = new electron__WEBPACK_IMPORTED_MODULE_0__.BrowserWindow({
    ...
    height: 300,
    webPreferences: {
      preload: path__WEBPACK_IMPORTED_MODULE_1___default().resolve(__dirname, 'preload.js')
    }
  });
  mainWindow.webContents.openDevTools();
  mainWindow.loadURL(isDev ? 'http://localhost:3000' : `file://${path__WEBPACK_IMPORTED_MODULE_1___default().resolve(__dirname, 'index.html')}`);
};
